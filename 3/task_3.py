...
Original file is located at
    https://colab.research.google.com/drive/15bTjvrenwR8kTxeJxmauCypiwpUiWhs3

Agent 1 (Hashtage Scrapper) (agent-3 Web search agent)
"""
...
if not GEMINI_API_KEY:
    raise ValueError("❌ Please set your Gemini API key in the code.")
...
def generate_smart_hashtags(keyword: str) -> str:
    ...
    return f"🏷️ Generated hashtags for '{keyword}':\n" + "\n".join(sorted(final_hashtags))
...
async def scrape_instagram_hashtags(keyword: str) -> str:
    ...
    try:
        async with async_playwright() as p:
            ...
            print(f"🔍 Scraping from Google search...")
            ...
            if hashtags:
                ...
                return f"🏷️ Scraped hashtags for '{keyword}':\n" + "\n".join(unique_hashtags)

    except Exception as e:
        print(f"⚠️ Browser scraping failed: Playwright not installed properly")
        print("💡 Falling back to smart hashtag generation...")
    ...
    try:
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                browser_test.close()
                print("✅ Playwright browsers detected - attempting scrape...")
        except Exception as browser_error:
            print("⚠️ Playwright browsers not found - using smart generation...")
            return generate_smart_hashtags(keyword)
        ...
        print(f"⚠️ Scraping failed, using smart generation: {str(e)}")
        return generate_smart_hashtags(keyword)
...
async def run_agent_task():
    print("🚀 InstaGrowth AI Agent Ready!")
    print("💡 This tool helps you find Instagram hashtags for your content")
    print("-" * 50)

    while True:
        try:
            keyword = input("\n📝 Enter a keyword to find Instagram hashtags (or type 'exit' to quit): ").strip()
...
if __name__ == "__main__":
    ...
    try:
        if is_jupyter():
            ...
            print("🔄 Detected Colab environment - using sync mode...")
            try:
                import nest_asyncio
                nest_asyncio.apply()  # Allow nested event loops
            except ImportError:
                print("⚠️ Installing nest-asyncio: pip install nest-asyncio")
            run_agent_sync()
        else:
        ...
        print(f"\n❌ Fatal error: {str(e)}")
        print("💡 Try running: pip install nest-asyncio")